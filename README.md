...
#### A1： 点击最新版本左上角的「赞助」按钮，赞助完成后填入对应档位的赞助信息，然后将信息和付款截图发给我。

可以加入[DoroHelper 反馈群](https://qm.qq.com/q/f0Q1yr7vzi)(584275905)并私信我，也可以发我的 qq 邮箱(1204244136@qq.com)，24 小时内我会进行登记并通知，之后重启软件即可
