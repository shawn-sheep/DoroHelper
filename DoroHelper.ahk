...
FindText().PicLib("|<灰色的咨询次数0>5C5C5F-0.65$20.3zw1zzUzzwTzzbk3zs0Tw03z00zk0Dw03z00zk0Dw03z00zk0Dy07rzztzzyDzz1zzU7zUU", 1)
...
AwardLoveTalking() {
    ...
    AddLog("===妮姬咨询任务开始===")
    while true {
        if (ok := FindText(&X, &Y, NikkeX + 0.572 * NikkeW . " ", NikkeY + 0.835 * NikkeH . " ", NikkeX + 0.572 * NikkeW + 0.008 * NikkeW . " ", NikkeY + 0.835 * NikkeH + 0.013 * NikkeH . " ", 0.3 * PicTolerance, 0.3 * PicTolerance, FindText().PicLib("灰色的咨询次数0"), , , , , , , TrueRatio, TrueRatio)) {
            AddLog("咨询次数已耗尽")
            break
        }
        if A_Index > 20 {
