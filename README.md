...
#### A2： 会员对于当前版本是永久的，且至少会持续两个大活动（约半年）。之后再更新版本，就需要重新赞助了

---

#### Q3： 其他游戏的脚本都是免费使用的，为什么到你这就收费？

#### A3： 基础功能仍然是免费使用的，但是维护新活动需要我付出相当多的精力，希望能够理解
